    ...
    <div className="rounded bg-white shadow relative p-5">
      <div className={`${!isAvailable(product.inventory) && "opacity-40"}`}>
        ...
        {isAvailable(product.inventory) ? (
          ...
          <p className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -transform-y-1/2 bg-gray-200 opacity-60 w-full text-center py-5 text-2xl uppercase font-bold">
            Agotado
          </p>
        )}
      </div>
